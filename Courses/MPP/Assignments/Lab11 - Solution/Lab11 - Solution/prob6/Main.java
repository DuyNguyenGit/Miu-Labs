...
public class Main {
	...
	public static void test1() {
		...
		boolean result = Main.contains2(list, "Tom");
	...
	public static void test2() {
		...
		boolean result = Main.contains2(list, new Employee(1003, "Tom", 60000));
		System.out.println(result);
	}
	...
	public static void test4() {
		...
		boolean result = Main.contains2(list, new CheckingAccount(1001, 25.00));
		System.out.println(result);
	}
