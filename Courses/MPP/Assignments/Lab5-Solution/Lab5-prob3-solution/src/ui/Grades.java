...
import control.DestinationScreen;
import data.Data;


@SuppressWarnings("serial")
public class Grades extends JFrame implements DestinationScreen {
	...
	@Override
	public void showDestinationScreen(String username) {
		...
		setGrades(sb.toString());
		setTitle("Grades for " + username);
		setHeading("Grades for " + username);
		setVisible(true);
	}
}
